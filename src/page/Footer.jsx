    ...
    return (
        <>
            <section className='px-4 px-15 lg:px-[112px] text-[#212121]'>
                <div className='flex flex-col md:flex-row justify-between gap-10 md:gap-[40px] lg:gap-[60px] bg-[#FFD700] px-6 lg:px-[50px] pt-[55px] pb-[11px] text-[18px]'>
                    ...
                    <div className='w-full md:w-[290px]'>
                        ...
                        <div className='flex flex-col'>
                            <textarea placeholder='Write your complain here...' className='bg-[#D32F2F] rounded-[10px] p-5 h-[155px] resize-none outline-none mb-4'></textarea>
                            <button className='bg-[#D32F2F] hover:bg-[#9b1c1c] rounded-[7px] text-[22px] p-[5px]'>Submit</button>
                        </div>
                    </div>

                    <div className='flex flex-col justify-between'>
                        <div className='grid grid-cols-3 md:flex gap-4 md:gap-[35px] lg:gap-[80px] text-[13px] sm:text-[15px] md:text-[18px]'>
                ...
                <div className='w-full h-[50px] bg-[#D32F2F]'></div>
            </section>
        </>
    )
}
